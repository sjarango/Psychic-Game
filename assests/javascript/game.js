...
console.log("letter is: " + letter); // check for winning letter in console
...
function randomLetter() {
    randomNum = Math.floor(Math.random() * 26); //change to 26 for final product, set to 3 to test (a,b,c)
...
function reset() {
    ...
    letter = randomLetter();
    console.log("new letter is: " + letter); // check for winning letter in console
    guessesLeft = limit;
    //console.log("guesses left: " + guessesLeft);
    guesses = '';
    var str1, str2 = '';
